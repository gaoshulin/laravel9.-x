...
return [
    ...
    'official_account' => [
        'default' => [
            'app_id'  => env('WECHAT_OFFICIAL_ACCOUNT_APPID', 'wx75d67e282539bd06'),     // AppID
            'secret'  => env('WECHAT_OFFICIAL_ACCOUNT_SECRET', 'a5ad53fa0941ad1a2820fb287ae6d853'),    // AppSecret
            'token'   => env('WECHAT_OFFICIAL_ACCOUNT_TOKEN', 'echotikwechate13t'),     // Token
            'aes_key' => env('WECHAT_OFFICIAL_ACCOUNT_AES_KEY', 'p78h1cC4P2yEsr4XU7Gh4ndXYjTQFzA4Z9DXAEX2N3H'),   // EncodingAESKey
